...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        buttonBrowse.setOnClickListener() {
            Intent(Intent.ACTION_VIEW).setData(Uri.parse("https://malay-thakkar.github.io/website/website/index.html")).apply {
                startActivity(this)
            }
        }

        buttonCall.setOnClickListener() {
            Intent(Intent.ACTION_DIAL).setData(Uri.parse("8320135247")).apply {
                startActivity(this)
            }
        }
